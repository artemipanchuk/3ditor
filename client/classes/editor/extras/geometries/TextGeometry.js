TextGeometry = function (text, parameters) {
	var textPath = new TextPath(text, parameters);
	...
	if (parameters.bend) {
		...
		parameters.bendPath = new QuadraticBezierCurve(new Vector2(0, 0),
...
TextGeometry.prototype = new ExtrudeGeometry();
...
self._typeface_js = { faces: FontUtils.faces, loadFace: FontUtils.loadFace };
