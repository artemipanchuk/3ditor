SVGRenderer = function () {
	...
	_svg = document.createElementNS('http:
	...
	function getLineNode(id) {
		if (_svgLinePool[id] == null) {
			_svgLinePool[id] = document.createElementNS('http:

			if (_quality == 0) {
				_svgLinePool[id].setAttribute('shape-rendering', 'crispEdges');
			}
	...
	function getPathNode(id) {
		if (_svgPathPool[id] == null) {
			_svgPathPool[id] = document.createElementNS('http:
	...
	function getCircleNode(id) {
		if (_svgCirclePool[id] == null) {
			_svgCirclePool[id] = document.createElementNS('http:

			if (_quality == 0) {
				_svgCirclePool[id].setAttribute('shape-rendering', 'crispEdges');
			}
