MorphAnimMesh = function (geometry, material) {
...
MorphAnimMesh.prototype = new Mesh();
...
MorphAnimMesh.prototype.updateAnimation = function (delta) {
	...
	var keyframe = this.startKeyframe + Math.clamp(Math.floor(this.time / frameTime), 0, this.length - 1);
