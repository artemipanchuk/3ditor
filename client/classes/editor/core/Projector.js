Projector = function() {
	...
	function getNextObjectInPool() {
		var object = _objectPool[_objectCount] = _objectPool[_objectCount] || new RenderableObject();
	...
	function getNextVertexInPool() {
		var vertex = _vertexPool[_vertexCount] = _vertexPool[_vertexCount] || new RenderableVertex();
	...
	function getNextFace3InPool() {
		var face = _face3Pool[_face3Count] = _face3Pool[_face3Count] || new RenderableFace3();
	...
	function getNextFace4InPool() {
		var face = _face4Pool[_face4Count] = _face4Pool[_face4Count] || new RenderableFace4();
	...
	function getNextLineInPool() {
		var line = _linePool[_lineCount] = _linePool[_lineCount] || new RenderableLine();
	...
	function getNextParticleInPool() {
		var particle = _particlePool[_particleCount] = _particlePool[_particleCount] || new RenderableParticle();
		_particleCount ++;
		return particle;
	}
